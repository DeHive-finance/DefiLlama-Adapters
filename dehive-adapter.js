...
const abi = require('./projects/dehive/abi.json')
...
async function chainTvl(chain, chainBlocks, stakingInfo) {
    const tvl = {};
...
async function ethereumTvl(timestamp, ethBlock, chainBlocks, stakingInfo) {
    return chainTvl('ethereum', chainBlocks, stakingInfo)
}

async function polygonTvl(timestamp, ethBlock, chainBlocks, stakingInfo) {
    return chainTvl('polygon', chainBlocks, stakingInfo);
}

async function bscTvl(timestamp, ethBlock, chainBlocks, stakingInfo) {
    return chainTvl('bsc', chainBlocks, stakingInfo);
}

async function xdaiTvl(timestamp, ethBlock, chainBlocks, stakingInfo) {
    return chainTvl('xdai', chainBlocks, stakingInfo)
}
